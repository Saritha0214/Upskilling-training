...
public class Collections03 {
	...
	public static void main(String[] args) {
		...
		Employee e4=(new Employee(18407,"Saritha","IT",28000));
		Employee e5=(new Employee(18402,"Rasagna","HT",40000));
		...
		Employee e9=(new Employee(18406,"Shabeena","DT",26000));
		Employee e10=(new Employee(18407,"Bhavya","CT",45000));
